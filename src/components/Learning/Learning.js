          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-[47px]">
            <div className="col-span-2">
              ...
              <p className="content">
                ...
                aliquam tellus, malesuada congue mattis in proin ac posuere
                arcu, lacus pulvinar diam massa sem phasellus non sagittis,
                volutpat tellus ornare eget tincidunt faucibus elementum tortor
                ...
                urna cursus lacus quam pellentesque mauris blandit nunc,
                fringilla pulvinar nec cum eleifend nisi, vestibulum ultrices
                tellus neque at sed enim mattis suspendisse nulla id nec quam ut
                et.{" "}
              </p>
            </div>
            <div className="learning_video">dfdfdffddfdf</div>
          </div>
        </div>
      </div>
    </>
